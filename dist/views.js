...
import { vNode, View } from "/node_modules/@ocdladefense/view/view.js"; // import * as React from 'react';
...
function _switchView() {
  _switchView = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name) {
    var module, newNode, oldNode;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            oldNode = updateView(newNode); // Place the old domtree in the cache,
            // for later use, i.e., when we 
            // switch back to list view.

            viewCache[currentView] = oldNode;
            currentView = name; // Post-render operations.
